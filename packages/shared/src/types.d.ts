 ...
 */
export type ReportStatus = "draft" | "processing" | "ready" | "flagged" | "archived";
/**
 ...
 */
export type AICollaborationLevel = "none" | "light_assist" | "co_author" | "heavy_ai";
/**
...
export interface ProcessLedgerEntry {
     ...
     */
    entryType: "metrics_snapshot" | "ai_event" | "document_save" | "session_start" | "session_end" | "milestone";
